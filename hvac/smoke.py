...
class SmokeSystem:
    ...
    fire_perimeter_auto: bool = False      # True — P пересчитывается по ф.(4)
                                            # от наибольшего привязанного помещения
                                            # при каждом расчёте
...
DEFAULT_SMOKE_NORMS = {
    ...
    "technical":         50.0,        # техпомещение с горючей нагрузкой
                                      # (кабельное, электрощитовая)
