...
КМК 2.01.04-18 форм.(1) и нормативов ШНҚ. Форм.(1) отсылает к периоду ≤10°C
отменённой ҚМҚ 2.01.01-94; действующая норма табулирует пороги ≤8°C и
≤12°C — для Dd принят период ≤12°C (см. energy.py):
